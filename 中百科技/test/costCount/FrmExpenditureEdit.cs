...
{
    public partial class FrmExpenditureEdit : BaseForm
    {
        ...
        private expenditureClass GetValueExpenditure()
        {
            expenditureClass recInfo = new expenditureClass();
        ...
        //窗体上的值装入实体类expenditureClass
        private waitDetachExpenditureClass GetValueWaitDetachExpenditure()
        {
            waitDetachExpenditureClass recInfo = new waitDetachExpenditureClass();
        ...
        private DataTable AddDateTable()
        {
            ...
            {
                waitDetachExpenditureClass waitDetachInfo = new waitDetachExpenditureClass();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            meg = IsFull();
            //FormHelper validate = new FormHelper();
            //validate.inputCheck(groupBox2);
      ...
      private void btnDelete_Click(object sender, EventArgs e)
        ...
        *
        */
        public void ExpenditureToDataRow(expenditureClass info, ref DataRow dr)
        {
        ...
        *
        */
        public void WaitDetachExpenditureToDataRow(waitDetachExpenditureClass info, ref DataRow dr)
        {
            dr["id"] = info.id == null ? "" : info.id;
            dr["ekId"] = info.ekId == null ? "" : info.ekId;
            dr["enId"] = info.enId == null ? "" : info.enId;
     ...
     */        
        ...
        {           
            if (dtLast.Rows.Count != 0)
            {
                ...
                bool saveSuccess;
                saveSuccess = editLogic.saveLastTable(dtLast);
                if (saveSuccess)
                {
