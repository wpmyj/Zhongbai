...
{
    public partial class FrmBitumenExpenditureEdit  : BaseForm
    {
        ...
        public FrmBitumenExpenditureEdit()
        {
            InitializeComponent();
        }
        ...
        private bitumenExpenditureClass GetValueExpenditure()
        {
            bitumenExpenditureClass recInfo = new bitumenExpenditureClass();
        ...
        //窗体上的值装入实体类expenditureClass
        private bitumenWaitDetachExpenditureClass GetValueWaitDetachExpenditure()
        {
            bitumenWaitDetachExpenditureClass recInfo = new bitumenWaitDetachExpenditureClass();
        ...
        private DataTable AddDateTable()
        {
            ...
            {
                bitumenWaitDetachExpenditureClass waitDetachInfo = new bitumenWaitDetachExpenditureClass();
        ...
        *
        */
        public void ExpenditureToDataRow(bitumenExpenditureClass info, ref DataRow dr)
        {
        ...
        *
        */
        public void WaitDetachExpenditureToDataRow(bitumenWaitDetachExpenditureClass info, ref DataRow dr)
        {
            dr["id"] = info.id == null ? "" : info.id;
            dr["ekId"] = info.ekId == null ? "" : info.ekId;
            dr["enId"] = info.enId == null ? "" : info.enId;
     ...
     */
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (dtLast.Rows.Count != 0)
            {
                ...
                bool saveSuccess;
                saveSuccess = editLogic.saveLastBitumenTable(dtLast);
                if (saveSuccess)
                {
