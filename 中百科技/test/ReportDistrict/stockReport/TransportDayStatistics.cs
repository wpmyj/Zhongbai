...
{
    class TransportDayStatistics : StockBase
    {
        ...
        public void ShowReport()
        {
            ...
            oArrayList.Add("Storage_transportDayStatistics");
            frmRPT.MainDataSourceName = oArrayList;
            frmRPT.ReportPath = Application.StartupPath + @"\TransportDayStatistics.rdlc";
