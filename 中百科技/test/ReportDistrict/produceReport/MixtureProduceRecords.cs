...
namespace DasherStation.ReportDistrict.produceReport
{
    ...
    /// 混合料生产情况记录表
    /// </summary>
    class MixtureProduceRecords : ProduceBase
    {
        ...
        public void ShowReport()
        {
            ...
            oArrayList.Add("ProduceDataSet_混合料生产情况记录");
            oArrayList.Add("ProduceDataSet_生产配合比信息");
            oArrayList.Add("ProduceDataSet_目标配合比信息");
            frmRPT.MainDataSourceName = oArrayList;
            frmRPT.ReportPath = Application.StartupPath + @"\MixtureProduceRecords.rdlc";
