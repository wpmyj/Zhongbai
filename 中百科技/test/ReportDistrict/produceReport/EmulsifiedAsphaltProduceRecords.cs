...
namespace DasherStation.ReportDistrict.produceReport
{
    ...
    /// 乳化沥青生产情况记录表
    /// </summary>
    class EmulsifiedAsphaltProduceRecords : ProduceBase
    {
        ...
        public void ShowReport()
        {
            ...
            oArrayList.Add("ProduceDataSet_沥青生产情况记录");
            oArrayList.Add("ProduceDataSet_目标配合比信息");
            frmRPT.MainDataSourceName = oArrayList;
            frmRPT.ReportPath = Application.StartupPath + @"\EmulsifiedAsphaltProduceRecords.rdlc";
