...
namespace DasherStation.ReportDistrict.produceReport
{
    ...
    /// 沥青加温生产情况记录表
    /// </summary>
    class HeatingAsphaltProduceRecords : ProduceBase
    {
        ...
        public void ShowReport()
        {
            ...
            oArrayList.Add("ProduceDataSet_沥青加温生产情况记录");
            frmRPT.MainDataSourceName = oArrayList;
            frmRPT.ReportPath = Application.StartupPath + @"\HeatingAsphaltProduceRecords.rdlc";
