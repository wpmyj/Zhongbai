...
{
    public class OvenUsedEnergyRecord:ProduceBase
    {
        ...
        public void ShowReport()
        {
            ...
            oArrayList.Add("ProduceDataSet_热油炉能源消耗记录");
            frmRPT.MainDataSourceName = oArrayList;
            frmRPT.ReportPath = Application.StartupPath + @"\OvenUsedEnergyRecord.rdlc";
            frmRPT.HBody = 22.2;
